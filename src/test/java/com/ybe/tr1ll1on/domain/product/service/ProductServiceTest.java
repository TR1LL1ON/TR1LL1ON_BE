...
// <<<<<<< develop
// //        when(productRepository.findByAccommodationIdAndMaximumNumberIsGreaterThanEqual(
// //                any(), any())).thenReturn(Collections.singletonList(product1));
// =======
// //        when(productRepository.findByAccommodationIdAndStandardNumberLessThanEqualAndMaximumNumberGreaterThanEqual(
// //                any(), any(), any())).thenReturn(Collections.singletonList(product1));
// >>>>>>> main
...
// =======
// //        when(productRepository.findByAccommodationIdAndStandardNumberLessThanEqualAndMaximumNumberGreaterThanEqual(
// //                any(), any(), any())).thenReturn(Collections.singletonList(product2));
// >>>>>>> main
// //        when(productInfoPerNightRepository.findByDateBetweenAndProductId(
// //                any(), any(), any())).thenReturn(Collections.emptyList()); // 여기서 필요한 데이터 설정
// //
