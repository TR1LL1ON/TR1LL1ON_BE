...
@NoArgsConstructor
@Builder
public class ProductAllReviewResponse {
    @Schema(example = "1")
    ...
    @ArraySchema(schema = @Schema(implementation = ProductAllReviewResponse.UserDetailsResponse.class))
    private UserDetailsResponse userDetails;
    @ArraySchema(schema = @Schema(implementation = ProductAllReviewResponse.ProductDetailsResponse.class))
    ...
    public static ProductAllReviewResponse fromEntity(Review review) {

        return ProductAllReviewResponse.builder()
