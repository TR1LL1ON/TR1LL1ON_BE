...
| <ul><li>초기설정(깃허브)</li><li>장바구니</li></ul> | <ul><li>초기설정(깃허브)</li><li>숙소전체조회(무한스크롤)</li></ul> | <ul><li>상품 상세 조회</li><li>상품 결제</li><li>찜 기능</li><li>CI/CD 서버 배포</li></ul>   | <li>OPEN API</li><ul><li>시큐리티</li><li>리뷰</li><li>마이페이지</li></ul> |   
